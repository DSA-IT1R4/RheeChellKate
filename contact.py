...
def message_contact():
    ...
    tk.Label(msg_window, text=f"Send message to: {phone}", bg="#83004f", fg="white", font=("Segoe UI", 11, "bold")).pack(pady=10)
    ...
    tk.Button(msg_window, text="Send", bg="#06b6d4", fg="white", font=("Segoe UI", 10, "bold"), command=send_message).pack(pady=5)    
...
def sort_by_name():
    ...
    status_label.config(text="Successfully Sorted A-Z!")
...
header_left = tk.Frame(header, bg="#83004f")
header_left.pack(side="left")

tk.Label(header, text="ALL CONTACTS", bg="#83004f", fg="white", font=("Segoe UI", 10)).pack(side="left", anchor="w", padx=10, pady=5)
